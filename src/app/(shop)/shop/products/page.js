  ...
  const applyFilters = () => {
    const filteredProducts = data.filter((product) => {
      ...
      const matchesSearchQuery =
        ...
        // For example: product.description && product.description.toLowerCase().includes(searchQuery.toLowerCase())
        false;
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="block appearance-none w-full bg-white border border-gray-300 py-2 px-4 pr-8 rounded-md leading-tight focus:outline-none focus:border-[#5B20B6] text-gray-900"
                >
